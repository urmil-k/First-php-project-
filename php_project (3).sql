...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2025 at 06:38 PM
...
INSERT INTO `orders` (`order_id`, `uid`, `name`, `email`, `address`, `phone`, `total_price`, `status`, `created_at`) VALUES
(1, 3, 'manoj shah', 'manoj@gmail.com', 'a505,rajhans,parvat patiya,surat', '9985664566', 295990.00, 'pending', '2025-12-04 22:30:56'),
(2, 2, 'meet virani', 'meet@gmail.com', 'c103,sahyog aparment,hirabag,surat', '9985664566', 751099.00, 'shipped', '2025-12-04 22:35:50');
...
INSERT INTO `order_items` (`id`, `order_id`, `pid`, `quantity`, `price`) VALUES
(1, 1, 10, 1, 185990.00),
(2, 1, 7, 1, 110000.00),
(3, 2, 5, 1, 750000.00),
(4, 2, 24, 1, 1099.00);
...
(10, 'Apple 2024 MacBook Pro Laptop with M4 Pro chip with 12‑core CPU and 16‑core GPU: Built for Apple Intelligence, (14.2″) Liquid Retina XDR Display, 24GB Unified Memory, 512GB SSD Storage; Space Black', 3, 1, 185990.00, 'Processor: Apple M4 Pro\r\nDisplay: 35.97 cms (14.2 inches), Liquid Retina XDR\r\nMemory: 24GB Unified Memory RAM, 512GB SSD ROM\r\nOS: macOS Sequoia\r\nGraphics: Apple\r\nBuilt for Apple Intelligence, Touch ID, Ambient Light Sensor\r\nWarranty: 1 Year Limited', 'Yes', 'uploads/1756392933_mac4.jpg', 'mac', '2025-08-28 14:55:33', 1),
(11, 'Apple 2024 MacBook Air (13-inch, Apple M3 chip with 8-core CPU and 10‑core GPU, 24GB Unified Memory, 512GB) - Space Gray', 4, 0, 145990.00, 'Apple M4 chip with 10-core CPU, 8-core GPU, 16‑core Neural Engine\r\n16GB unified memory\r\n256GB SSD storage\r\n34.46 cm (13.6″) Liquid Retina display with True Tone²\r\n12MP Center Stage camera\r\nMagSafe 3 charging port\r\nTwo Thunderbolt 4 ports\r\n30W USB-C Power Adapter', 'Yes', 'uploads/1756392957_mac5.jpg', 'mac', '2025-08-28 14:55:57', 1),
...
(14, 'Apple iPad Pro 13″ (M4): Ultra Retina XDR Display, 256GB, Landscape 12MP Front Camera / 12MP Back Camera, LiDAR Scanner, Wi-Fi 6E, Face ID, All-Day Battery Life, Standard Glass — Space Black', 4, 0, 125000.00, '11 inches (28.22 cm) Ultra Retina XDR Display, 120 Hz Refresh Rate\r\n8GB RAM, 256GB ROM\r\nApple M4 Chip, 9 Core\r\niPadOS 18\r\nUpto 10 Hours Battery Life\r\n12 MP Primary Camera, 12 MP Front Camera\r\nFour Speaker Audio, Ambient light sensors, Fingerprint Resistant', 'Yes', 'uploads/1756393060_ipad3.jpg', 'ipad', '2025-08-28 14:57:40', 1),
(15, 'Apple iPad Mini (A17 Pro): Apple Intelligence, 21.08 cm (8.3″) Liquid Retina Display, 128GB, Wi-Fi 6E, 12MP Front/12MP Back Camera, Touch ID, All-Day Battery Life — Blue', 3, 0, 39999.00, '11 inches (27.59 cm) Liquid Retina Display, 60 Hz Refresh Rate\r\n128GB ROM\r\nApple A16 Chip, Penta Core\r\niPadOS 18\r\nUpto 10 Hours Battery Life\r\n12 MP Primary Camera, 12 MP Front Camera\r\nLandscape Stereo Speakers, Touch ID, Video Mirroring', 'Yes', 'uploads/1756393083_ipad4.jpg', 'ipad', '2025-08-28 14:58:03', 1),
...
(17, 'Apple Watch SE (2nd Gen, 2023) [GPS 40mm] Smartwatch with Silver Aluminum Case with Blue Cloud Sport Loop. Fitness & Sleep Tracker, Crash Detection, Heart Rate Monitor, Retina Display', 4, 0, 25000.00, 'Operating System-Android, iOS\r\nMemory Storage Capacity-32 GB\r\nSpecial Feature-Sedentary Reminder, Sleep Monitor\r\nConnectivity Technology	- Wi-Fi 4 (802.11n);Bluetooth 5.3\r\nWireless Communication Standard', 'Yes', 'uploads/1756393146_watch2.jpg', 'watch', '2025-08-28 14:59:06', 1),
...
(19, 'Apple Watch Series 10 [GPS + Cellular 46 mm] Smartwatch with Jet Black Aluminium Case with Ink Sport Loop. Fitness Tracker, ECG App, Always-On Retina Display, Carbon Neutral', 4.5, 0, 59990.00, 'Operating System-Ios\r\nMemory Storage Capacity-64 GB\r\nSpecial Feature-Fall Detection and Crash Detection\r\nConnectivity Technology - Wi-Fi 4 (802.11n);Bluetooth 5.3\r\nWireless Communication Standard', 'Yes', 'uploads/1756393193_watch4.jpg', 'watch', '2025-08-28 14:59:53', 1),
...
INSERT INTO `reviews` (`id`, `pid`, `uid`, `rating`, `comment`, `created_at`) VALUES
(4, 10, 3, 3, 'product is good but the price is expansive.', '2025-12-04 16:57:27'),
(5, 11, 3, 4, 'product is good but the price is expansive.', '2025-12-04 16:57:49'),
(6, 14, 3, 4, 'product is good but the price is expansive.', '2025-12-04 16:58:07'),
(7, 15, 3, 3, 'product is good but the price is expansive.', '2025-12-04 16:58:25'),
(8, 7, 3, 3, 'product is good but the price is expansive.', '2025-12-04 16:59:02'),
(9, 19, 3, 5, 'product is good but the price is expansive.', '2025-12-04 16:59:18'),
(10, 5, 2, 4, 'good product i like it.', '2025-12-04 17:03:47'),
(11, 19, 2, 4, 'good product i like it.', '2025-12-04 17:04:05'),
(12, 17, 2, 4, 'good product i like it.', '2025-12-04 17:04:24'),
(13, 24, 2, 5, 'good product i like it.', '2025-12-04 17:04:33'),
(14, 23, 2, 5, 'good product i like it.', '2025-12-04 17:04:46');
...
(3, 'manoj', 'shah', 'manoj', 'manoj@gmail.com', '$2y$10$W5HuPMY2KhW2b29/Ilh4MuuPcij8t6Pyrd.u0vdC8mDJgfp2j0EAy', '2025-12-04 16:33:27'),
(4, 'shubham', 'sonawane', 'shubham', 'shubham@gmail.com', '$2y$10$5XvQak7VkFEQHD8ePzU9mu1tk/BZ44hBS7QXV4lXZDN9AlRG8UHG6', '2025-12-04 16:52:08'),
(5, 'piyush', 'pandit', 'piyush', 'piyush@gmail.com', '$2y$10$NNvZ2LtkVPA9Y2jH0lXMA.U/vL1G7NXWSg5r9VmvsMbInpo7EYUTG', '2025-12-04 16:52:35'),
(6, 'rudresh', 'raval', 'rudresh', 'redresh@gmail.com', '$2y$10$DaCsFTrLI2l96qhpL38SgeMgeRUqZDJmuPZpP5eH.mthSaMukZj/a', '2025-12-04 16:53:14'),
(7, 'rishi', 'patel', 'rishi', 'rishi@gmail.com', '$2y$10$bag5azjYnl/pbqIq0qAR/.VEwPg6Ck/vLxCQCkIwwUNkX1WVd7Yoi', '2025-12-04 16:53:41'),
(8, 'dhruv', 'patel', 'dhruv', 'dhruv@gmail.com', '$2y$10$cXOh4K0OLUbX.ZRemGSHTuovUN52lxzflkS5RaiyUwoszGiJOtWpW', '2025-12-04 16:54:28'),
(9, 'jatin', 'jedhava', 'jatin', 'jatin@gmail.com', '$2y$10$SqvN6oGgp14COQFq6ADJmerYdr1nd7NMRUItBAHhm4V7kYXRHk7.a', '2025-12-04 16:55:09');
